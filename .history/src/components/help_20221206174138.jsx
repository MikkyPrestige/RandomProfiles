    ...
    <div>
      <div className="help">
        ...
        <ul className="help__list">
          ...
          <li className="help__item">
            User can also click on the 'USERS' in the header to see the random users in the app
          </li>
          <li className="help__item">
            User can also click on the 'HOW IT WORKS' in the header to see the
            help text.
          </li>
          <li className="help__item">
            User can also click on the 'SEARCH' tab in the header to search for
            Users with letters from their names or other criteria{" "}
          </li>
          <li className="help__item">
            User can also click on the 'HOME' button in the header to go back to
            the home page.
          </li>
        </ul>
      </div>
