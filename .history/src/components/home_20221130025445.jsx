      ...
      <div className="home__container">
        ...
        <div className="home__wrapper">
          ...
          <div className="home__img">
            <Avatar image={FirstFemale} alt="Female One" style={{ width: '5rem', height: '5rem', borderRadius: '50%' }}/>
            <Avatar image={SecondFemale} alt="Female Two" style={{ width: '5rem', height: '5rem', borderRadius: '50%' }}/>
            <Avatar image={FirstMale} alt="Male One" style={{ width: '5rem', height: '5rem', borderRadius: '50%' }}/>
            <Avatar image={ThirdFemale} alt="Female Three" style={{ width: '5rem', height: '5rem', borderRadius: '50%' }}/>
            <Avatar image={SecondMale} alt="Male Two" style={{ width: '5rem', height: '5rem', borderRadius: '50%' }}/>
          </div>
        </div>
      </div>
    </div>
