 ...
 return (
  <div className="help">
   ...
   <ul className="help__list">
      <h2 className="help__text">This app uses a Random User Generator API to fetch a list of random People. The people are displayed in the app UI. The list can be filtered.</h2>
    <li className="help__item">Click on 'Go to Profile' in home page to sign in to your account or register</li>
