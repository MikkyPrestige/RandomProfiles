        ...
        <div className="profile__desc">
          {user ? (
            <div className="profile__user">
              ...
              <Avatar image={user.photoURL} alt="user" className="profile__avatar" style={{ width: '10rem', height: '10rem', borderRadius: '50%' } } />
              <p className="profile__name"><strong>Sign in account name: </strong>{user.displayName}</p>
              <p className="profile__text"><strong>Signed in email: </strong>{user.email}</p>
