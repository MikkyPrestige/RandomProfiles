...
import { auth, provider, signInWithRedirect, onAuthStateChanged, signInWithEmailAndPassword, signOut, deleteUser } from "../config";
      ...
      {user ? (
        ...
        <div className="profile__user">
          <div className="sign__wrapper">
            ...
            <h2 className="sign__heading">Sign in with your email and password</h2>
