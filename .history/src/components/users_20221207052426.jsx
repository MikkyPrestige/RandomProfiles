...
const Users = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://randomuser.me/api/?page=${page}&results=6`) // 8. Fetch the users from the API using the page state variable to determine the page number to fetch from the API
  ...
  return (
    <div className="users">
      ...
      <div className="users__container">
        {loading && <h2>Loading random users...</h2>}
        {error && <h2>{error.message}, Please check your internet connection.</h2>}
