          ...
          {user ? (
            ...
            <div className="profile__user">
              <div className="profile__wrapper">
                ...
                <h2 className="profile__head">Sign in with Google account</h2>
                <button onClick={signIn} className="sign__btn">
                  Click here
                </button>
                <p className="or">OR</p>
                <h2 className="profile__head">Sign in with email and password</h2>
              ...
              <h2 className="register__title">Register a new account with Us!!!</h2>
