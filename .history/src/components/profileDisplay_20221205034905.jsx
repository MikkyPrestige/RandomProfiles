...
const ProfileDisplay = () => {
  ...
  const recaptchaVerifier = new RecaptchaVerifier("#sign-in-btn", {
    'size': "invisible",
    'callback': (response) => {
  ...
  const onSignInSubmit = (e) => {
    ...
    signInWithPhoneNumber(auth, phoneNumber, recaptchaVerifier)
      .then((confirmationResult) => {
        ...
        const code = window.prompt("Enter the code that was sent to your mobile device.");
              ...
              <div className="sign__wrapper">
                ...
                <form onSubmit={handleSignIn} className="sign__form">
                  <input
                    ...
                    required
                  />
                  <button type="submit" id="sign-in-btn" className="sign__btn">
                    Sign In
                  </button>
                  {
